...
#rnot = 20
#alpha = 0.1
#theta = np.linspace(-20,20,101)
#downwind = np.linspace(120, 320, 101)
#
#
...
plt.plot(theta,Model2[100,:,50]/u)
plt.xlabel('\u0394 \u03F4 Degrees')
plt.ylabel('u/v')
...
plt.plot(theta,Model[100,:,50]/u)
plt.xlabel('\u0394 \u03F4 Degrees')
plt.ylabel('u/v')
plt.setp(ax1.get_xticklabels(), visible=False)
ax6.legend({"Jensen","My Code"}, frameon = False, bbox_to_anchor=(-1.1,-.7))
